					...
					<div class="col-sm-3">
						...
						<div class="card " style="width: 18rem;">
							...
							<div class="card-body" align="left">
								...
								<?php } else { ?>
									<a href="<?php echo base_url() . $row['qrcode_order'] ?>" class="card-link"
										download>Download
										QrCode</a>
								<?php } ?>
								<h5 class="card-title">Booking Code :
								...
								<p>Name :
									...
									<?php if ($row['status_order'] == '1') { ?>
										<a href="<?php echo base_url('tiket/payment/' . $row['kd_order']) ?>"
											class="btn btn-primary">Check Payment</a>
									<?php } else if ($row['status_order'] == '3') { ?>
											<a href="<?php echo base_url('tiket/') ?>" class="btn btn-warning pull-right">Book
												Another</a>
									<?php } else { ?>
											...
											<a href="<?php echo base_url('assets/backend/upload/etiket/' . $row['kd_order'] . '.pdf') ?>"
												class="btn btn-success pull-right" download>Print Ticket</a>
									<?php } ?>
							</div>
						</div>
					</div>
